      ...
      <div className="flex-1 flex flex-col max-w-2xl mx-auto w-full relative z-10 px-4 py-8">
        <div className="text-center mb-6">
          ...
          <p className="text-white/70 text-sm mt-1">
            Danh sách lộc xuân đã nhận (sắp xếp theo số tiền)
          </p>
        </div>
        ...
        {error && (
          <div className="bg-red-900/30 border border-red-500/50 rounded-xl p-4 text-center text-white/90">
            {error}
            <p className="text-sm text-white/60 mt-2">Danh sách lưu từ tin nhắn bot. Hãy đảm bảo đã có ít nhất một lần nhận lì xì và server có quyền ghi file data.</p>
          </div>
        )}
